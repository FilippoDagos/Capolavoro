...
<?php 
 ...
 // Query per ottenere i post dell'utente specifico
 $query_posts = " SELECT posts.*, users.username
 FROM posts
...
if ($likeCount > 0) {
    ...
    <button class="comment-button">
        <i class="uil uil-comment-dots"></i> Comment
    </button>
</form>
